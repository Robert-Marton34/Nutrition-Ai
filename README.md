...
<details> <summary>How to get a Gemini API key</summary>
Visit makersuite.google.com/app/apikey
Sign in with a Google account
Click Create API Key
Copy the key into your .env file as GEMINI_API_KEY
</details> <details> <summary>How to get an OpenAI API key</summary>
Visit platform.openai.com and sign up or log in
Navigate to API Keys
Click Create new secret key
Go to Billing and add at least $5 in credits (the key won't work without a positive balance)
Copy the key into your .env file as OPENAI_API_KEY
</details>
